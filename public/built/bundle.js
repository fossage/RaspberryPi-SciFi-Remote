...
/******/ 	var hotCurrentHash = "ffac1293916accde58c1"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports) {
	...
	var decorateEl = exports.decorateEl = function () {
	  var uid = 0;
	  return function (el) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dum = __webpack_require__(190);

	var electron = __webpack_require__(192);
	...
	Object.defineProperties(x, {
	  attach: {
	    value: function value() {
	      ...
	      (0, _dum.decorateEl)(document.body);
	      ...
	      var fragment = (0, _dum.decorateEl)(document.createDocumentFragment());
	  ...
	  a: {
	    get: function get() {
	      return (0, _dum.createEl)('a');
	    }
	  },
	  p: {
	    get: function get() {
	      return (0, _dum.createEl)('p');
	    }
	  },
	  h1: {
	    get: function get() {
	      return (0, _dum.createEl)('h1');
	    }
	  },
	  h2: {
	    get: function get() {
	      return (0, _dum.createEl)('h2');
	    }
	  },
	  h3: {
	    get: function get() {
	      return (0, _dum.createEl)('h3');
	    }
	  },
	  h4: {
	    get: function get() {
	      return (0, _dum.createEl)('h4');
	    }
	  },
	  h5: {
	    get: function get() {
	      return (0, _dum.createEl)('h5');
	    }
	  },
	  h6: {
	    get: function get() {
	      return (0, _dum.createEl)('h6');
	    }
	  },
	  ul: {
	    get: function get() {
	      return (0, _dum.createEl)('ul');
	    }
	  },
	  ol: {
	    get: function get() {
	      return (0, _dum.createEl)('ol');
	    }
	  },
	  li: {
	    get: function get() {
	      return (0, _dum.createEl)('li');
	    }
	  },
	  div: {
	    get: function get() {
	      return (0, _dum.createEl)('div');
	    }
	  },
	  img: {
	    get: function get() {
	      return (0, _dum.createEl)('IMG');
	    }
	  },
	  small: {
	    get: function get() {
	      return (0, _dum.createEl)('small');
	    }
	  },
	  footer: {
	    get: function get() {
	      return (0, _dum.createEl)('footer');
	    }
	  },
	  header: {
	    get: function get() {
	      return (0, _dum.createEl)('header');
	    }
	  },
	  hgroup: {
	    get: function get() {
	      return (0, _dum.createEl)('hgroup');
	    }
	  },
	  nav: {
	    get: function get() {
	      return (0, _dum.createEl)('nav');
	    }
	  },
	  dd: {
	    get: function get() {
	      return (0, _dum.createEl)('dd');
	    }
	  },
	  dl: {
	    get: function get() {
	      return (0, _dum.createEl)('dl');
	    }
	  },
	  dt: {
	    get: function get() {
	      return (0, _dum.createEl)('dt');
	    }
	  },
	  figcaption: {
	    get: function get() {
	      return (0, _dum.createEl)('figcaption');
	    }
	  },
	  figure: {
	    get: function get() {
	      return (0, _dum.createEl)('figure');
	    }
	  },
	  hr: {
	    get: function get() {
	      return (0, _dum.createEl)('hr');
	    }
	  },
	  main: {
	    get: function get() {
	      return (0, _dum.createEl)('main');
	    }
	  },
	  pre: {
	    get: function get() {
	      return (0, _dum.createEl)('pre');
	    }
	  },
	  abbr: {
	    get: function get() {
	      return (0, _dum.createEl)('abbr');
	    }
	  },
	  b: {
	    get: function get() {
	      return (0, _dum.createEl)('b');
	    }
	  },
	  bdi: {
	    get: function get() {
	      return (0, _dum.createEl)('bdi');
	    }
	  },
	  bdo: {
	    get: function get() {
	      return (0, _dum.createEl)('bdo');
	    }
	  },
	  br: {
	    get: function get() {
	      return (0, _dum.createEl)('br');
	    }
	  },
	  cite: {
	    get: function get() {
	      return (0, _dum.createEl)('cite');
	    }
	  },
	  code: {
	    get: function get() {
	      return (0, _dum.createEl)('code');
	    }
	  },
	  data: {
	    get: function get() {
	      return (0, _dum.createEl)('data');
	    }
	  },
	  dfn: {
	    get: function get() {
	      return (0, _dum.createEl)('dfn');
	    }
	  },
	  em: {
	    get: function get() {
	      return (0, _dum.createEl)('em');
	    }
	  },
	  i: {
	    get: function get() {
	      return (0, _dum.createEl)('i');
	    }
	  },
	  kdb: {
	    get: function get() {
	      return (0, _dum.createEl)('kdb');
	    }
	  },
	  mark: {
	    get: function get() {
	      return (0, _dum.createEl)('mark');
	    }
	  },
	  q: {
	    get: function get() {
	      return (0, _dum.createEl)('q');
	    }
	  },
	  rp: {
	    get: function get() {
	      return (0, _dum.createEl)('rp');
	    }
	  },
	  rt: {
	    get: function get() {
	      return (0, _dum.createEl)('rt');
	    }
	  },
	  rtc: {
	    get: function get() {
	      return (0, _dum.createEl)('rtc');
	    }
	  },
	  ruby: {
	    get: function get() {
	      return (0, _dum.createEl)('ruby');
	    }
	  },
	  s: {
	    get: function get() {
	      return (0, _dum.createEl)('s');
	    }
	  },
	  samp: {
	    get: function get() {
	      return (0, _dum.createEl)('samp');
	    }
	  },
	  span: {
	    get: function get() {
	      return (0, _dum.createEl)('span');
	    }
	  },
	  strong: {
	    get: function get() {
	      return (0, _dum.createEl)('strong');
	    }
	  },
	  sub: {
	    get: function get() {
	      return (0, _dum.createEl)('sub');
	    }
	  },
	  sup: {
	    get: function get() {
	      return (0, _dum.createEl)('sup');
	    }
	  },
	  time: {
	    get: function get() {
	      return (0, _dum.createEl)('time');
	    }
	  },
	  u: {
	    get: function get() {
	      return (0, _dum.createEl)('u');
	    }
	  },
	  wbr: {
	    get: function get() {
	      return (0, _dum.createEl)('wbr');
	    }
	  },
	  area: {
	    get: function get() {
	      return (0, _dum.createEl)('area');
	    }
	  },
	  audio: {
	    get: function get() {
	      return (0, _dum.createEl)('audio');
	    }
	  },
	  map: {
	    get: function get() {
	      return (0, _dum.createEl)('map');
	    }
	  },
	  track: {
	    get: function get() {
	      return (0, _dum.createEl)('track');
	    }
	  },
	  video: {
	    get: function get() {
	      return (0, _dum.createEl)('video');
	    }
	  },
	  embed: {
	    get: function get() {
	      return (0, _dum.createEl)('embed');
	    }
	  },
	  object: {
	    get: function get() {
	      return (0, _dum.createEl)('object');
	    }
	  },
	  param: {
	    get: function get() {
	      return (0, _dum.createEl)('param');
	    }
	  },
	  source: {
	    get: function get() {
	      return (0, _dum.createEl)('source');
	    }
	  },
	  canvas: {
	    get: function get() {
	      return (0, _dum.createEl)('canvas');
	    }
	  },
	  caption: {
	    get: function get() {
	      return (0, _dum.createEl)('caption');
	    }
	  },
	  col: {
	    get: function get() {
	      return (0, _dum.createEl)('col');
	    }
	  },
	  colgroup: {
	    get: function get() {
	      return (0, _dum.createEl)('colgroup');
	    }
	  },
	  table: {
	    get: function get() {
	      return (0, _dum.createEl)('table');
	    }
	  },
	  tbody: {
	    get: function get() {
	      return (0, _dum.createEl)('tbody');
	    }
	  },
	  td: {
	    get: function get() {
	      return (0, _dum.createEl)('td');
	    }
	  },
	  tfoot: {
	    get: function get() {
	      return (0, _dum.createEl)('tfooter');
	    }
	  },
	  th: {
	    get: function get() {
	      return (0, _dum.createEl)('th');
	    }
	  },
	  thead: {
	    get: function get() {
	      return (0, _dum.createEl)('thead');
	    }
	  },
	  tr: {
	    get: function get() {
	      return (0, _dum.createEl)('tr');
	    }
	  },
	  button: {
	    get: function get() {
	      return (0, _dum.createEl)('button');
	    }
	  },
	  datalist: {
	    get: function get() {
	      return (0, _dum.createEl)('datalist');
	    }
	  },
	  fieldset: {
	    get: function get() {
	      return (0, _dum.createEl)('fieldset');
	    }
	  },
	  form: {
	    get: function get() {
	      return (0, _dum.createEl)('form');
	    }
	  },
	  input: {
	    get: function get() {
	      return (0, _dum.createEl)('input');
	    }
	  },
	  keygen: {
	    get: function get() {
	      return (0, _dum.createEl)('keygen');
	    }
	  },
	  label: {
	    get: function get() {
	      return (0, _dum.createEl)('label');
	    }
	  },
	  legend: {
	    get: function get() {
	      return (0, _dum.createEl)('legend');
	    }
	  },
	  meter: {
	    get: function get() {
	      return (0, _dum.createEl)('meter');
	    }
	  },
	  optgroup: {
	    get: function get() {
	      return (0, _dum.createEl)('optgroup');
	    }
	  },
	  option: {
	    get: function get() {
	      return (0, _dum.createEl)('option');
	    }
	  },
	  progress: {
	    get: function get() {
	      return (0, _dum.createEl)('progress');
	    }
	  },
	  select: {
	    get: function get() {
	      return (0, _dum.createEl)('select');
	    }
	  },
	  details: {
	    get: function get() {
	      return (0, _dum.createEl)('details');
	    }
	  },
	  dialog: {
	    get: function get() {
	      return (0, _dum.createEl)('dialog');
	    }
	  },
	  menu: {
	    get: function get() {
	      return (0, _dum.createEl)('menu');
	    }
	  },
	  menuitem: {
	    get: function get() {
	      return (0, _dum.createEl)('menuitem');
	    }
	  },
	  summary: {
	    get: function get() {
	      return (0, _dum.createEl)('summary');
	    }
	  },
	  ...
	  content: {
	    get: function get() {
	      return (0, _dum.createEl)('content');
	    }
	  },
	  element: {
	    get: function get() {
	      return (0, _dum.createEl)('element');
	    }
	  },
	  shadow: {
	    get: function get() {
	      return (0, _dum.createEl)('shadow');
	    }
	  },
	  template: {
	    get: function get() {
	      return (0, _dum.createEl)('template');
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _elements = __webpack_require__(191);

	var _basicTile = __webpack_require__(194);

	var _ocm = __webpack_require__(199);

	var _ocmButton = __webpack_require__(200);

	var _pane = __webpack_require__(201);

	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

	var TweenMax = __webpack_require__(197);
	var gpio = __webpack_require__(202);
	var electron = __webpack_require__(192);
	...
	var weatherPane = (0, _pane.Pane)({ color: 'RGB(255, 21, 30)', padding: '15px' });
	var wtl = undefined;

	weatherPane.subscribe('openWeather', function () {
	  wtl = TweenMax.to(weatherPane, 1.4, { y: 220, delay: 0.6 });
	}).click(function () {
	  weatherPane.publish('closePane', {});
	  wtl.reverse();

	  wtl.eventCallback('onReverseComplete', function () {
	    [].concat(_toConsumableArray(weatherPane.childNodes)).forEach(function (node) {
	      weatherPane.removeChild(node);
	    });
	  });
	});

	var weatherInner = weatherPane.subscribe('weatherLoaded', function (e, data) {
	  weatherPane.append(_elements.x.h1.text('Current Weather').setClass('blade'), _elements.x.hr, _elements.x.h1.text(data.main.temp + 'ºF').setClass('blade'), _elements.x.h3.text(data.weather[0].description).setClass('blade'));
	});

	var tileFragment = (0, _basicTile.Tile)(tileOpts);
	// let size = electron.screen.getPrimaryDisplay().workAreaSize;

	[].concat(_toConsumableArray(tileFragment.childNodes)).forEach(function (node, idx) {
	  var tm = undefined;
	  var amount = idx < 2 ? -700 : 700;

	  node.subscribe('openPane', function () {
	    tm = TweenMax.to(node, 2, { x: amount });
	  });

	  node.subscribe('closePane', function () {
	    tm.reverse();
	  });
	});

	var tiles = _elements.x.div.append(tileFragment).setStyles({ display: 'flex', justifyContent: 'center', padding: '15px' });

	tiles.childNodes[0].click(function (el) {
	  el.publish('openPane', {});
	  el.publish('openWeather', {});
	  fetch('http://api.openweathermap.org/data/2.5/weather?id=5809844&APPID=54d8527b214ab9b27a7a7ec7aee9efa0&units=imperial').then(function (response) {
	...
	var dimmer = _elements.x.div.setStyles({
	  height: '480px',
	  width: '800px',
	  position: 'absolute',
	...
	/*======== LINKAGE =======*/
	_elements.x.attach(dimmer, weatherPane, tiles);
	...
	function runDot(xfrom, xto, time) {
	  var dot1 = _elements.x.div.setStyles({
	  ...
	  TweenMax.fromTo(dot1, time, {
	    ...
	    onComplete: function onComplete() {
	      dot1.setStyles({ display: 'none' });document.body.removeChild(dot1);
	    }
	  });
	}
	...
	function dotRunner(xfrom, xto) {
	  var num = getRandom(2, 10) * 1000;
	  var num2 = getRandom(8, 22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stringUtils = __webpack_require__(195);

	var _componentFactory = __webpack_require__(196);

	var TweenMax = __webpack_require__(197);

	var Tile = exports.Tile = (0, _componentFactory.Component)(function (opts) {
	  ...
	  var rules = styles.boxShadow.split(' ');
	  var depressedBoxShadow = '';
	  ...
	  var innerDiv = _elements.x.div.setClass('tile-inner').setStyles(styles).mouseDown(function (el) {
	  ...
	  var title = _elements.x.h1.text(opts.text || 'hi').setStyles({
	    textAlign: opts.textAlign || 'center',
	    verticalAlign: opts.verticalAlign || 'middle',
	    fontSize: opts.fontSize || '1.6em'
	  });

	  return _elements.x.output(innerDiv.append(title));
	});
...
/***/ function(module, exports) {
	...
	var pxParser = exports.pxParser = function pxParser(rule) {
					...
					this.check = function(init) {
						...
						if (missing === 0 && func) {
							...
							if (global) {
								...
								if (!hasModule && "function" === "function" && __webpack_require__(198)){ //AMD
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OCM = exports.OCM = (0, _componentFactory.Component)(function (opts) {
	  ...
	  opts.items.forEach(function (item) {
	    items.push(_elements.x.li.append(_elements.x.h1.text(item)));
	  });

	  var container = _elements.x.div.setStyles(containerStyles).subscribe('openOCM', function (e) {
	  ...
	  container.append(_elements.x.ul.setStyles({ listStyle: 'none' }).append(items).subscribe('openOCM', function (el) {
	    TweenMax.staggerFrom(items, 0.2, { x: -200 }, 0.1);
	  }));

	  return _elements.x.output(container);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.OCMButton = undefined;

	var _elements = __webpack_require__(191);

	var _componentFactory = __webpack_require__(196);

	var OCMButton = exports.OCMButton = (0, _componentFactory.Component)(function (opts) {

	  var container = _elements.x.div;

	  var button = _elements.x.img.setSrc('../img/icon/text-lines.svg').click(function (el) {
	    el.publish('openOCM', {});
	  }).setStyles(opts);

	  return _elements.x.output(container.append(button));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pane = exports.Pane = (0, _componentFactory.Component)(function (opts) {
	  ...
	  var wrapper = _elements.x.div.setStyles(styles).mouseDown(function (el) {
	    TweenMax.to(el, 0.2, styles);
	    el.publish('closePane', {});
	  });

	  var heading = _elements.x.h1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"fs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
		...
		exec = __webpack_require__(204).exec;
